...
namespace BowieD.Unturned.NPCMaker.Export
{
    public static class ExportTool
    {
        ...
        private static void Export_Characters(IEnumerable<Character> characters)
        {
        ...
        private static void Export_Dialogues(IEnumerable<Dialogue> dialogues)
        {
            foreach (NPCDialogue dialogue in dialogues)
            {
                try
                {
                    ...
                    using (StreamWriter local = new StreamWriter(dir + $@"Dialogues\{dialogue.guid}_{dialogue.id}\English.dat", false, Encoding.UTF8))
                    {
                        asset.WriteLine($"// Generated by NPC Maker {MainWindow.Version} by BowieD");
                        local.WriteLine($"// Generated by NPC Maker {MainWindow.Version} by BowieD");
                        if (AppConfig.Instance.Properties.generateGuids)
        ...
        private static void Export_Vendors(IEnumerable<Vendor> vendors)
        {
        ...
        private static void Export_Quests(IEnumerable<Quest> quests)
        {
