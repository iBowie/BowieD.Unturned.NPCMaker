...
namespace BowieD.Unturned.NPCMaker.FindReplace
{
    ...
    public static class FindReplaceFormats
    {
        ...
        public static readonly FindReplaceFormat CHARACTER_GUID = new FindReplaceFormat("Character_GUID", typeof(Guid));
        public static readonly FindReplaceFormat CHARACTER_EditorName = new FindReplaceFormat("Character_EditorName", typeof(string));
        public static readonly FindReplaceFormat CHARACTER_DisplayName = new FindReplaceFormat("Character_DisplayName", typeof(string));
        public static readonly FindReplaceFormat DIALOGUE_ID = new FindReplaceFormat("Dialogue_ID", typeof(ushort));
        public static readonly FindReplaceFormat DIALOGUE_GUID = new FindReplaceFormat("Dialogue_GUID", typeof(Guid));
        ...
        public static readonly FindReplaceFormat VENDOR_GUID = new FindReplaceFormat("Vendor_GUID", typeof(Guid));
        public static readonly FindReplaceFormat QUEST_ID = new FindReplaceFormat("Quest_ID", typeof(ushort));
        public static readonly FindReplaceFormat QUEST_GUID = new FindReplaceFormat("Quest_GUID", typeof(Guid));
